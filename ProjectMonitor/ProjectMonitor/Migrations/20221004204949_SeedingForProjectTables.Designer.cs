...
namespace ProjectMonitor.Api.Migrations
{
    ...
    [Migration("20221004204949_SeedingForProjectTables")]
    partial class SeedingForProjectTables
    {
            ...
            modelBuilder.Entity("ProjectMonitor.Api.Database.Models.BreganTwitchBot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastDiscordLeaderboardsUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(355),
                            LastHoursUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(356),
                            StreamAnnounced = false,
                            StreamStatus = false,
                            StreamUptime = new TimeSpan(0, 0, 0, 0, 0),
                            TwitchApiKeyLastRefreshTime = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(359),
                        ...
                        new
                        {
                            ...
                            DailyPointsEnabled = false,
                            DiscordConnectionStatus = true,
                            LastDiscordLeaderboardsUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(361),
                            LastHoursUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(361),
                            StreamAnnounced = false,
                            StreamStatus = false,
                            StreamUptime = new TimeSpan(0, 0, 0, 0, 0),
                            TwitchApiKeyLastRefreshTime = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(361),
                            TwitchIRCConnectionStatus = true,
                            TwitchPubSubConnectionStatus = true,
                            UsersInStream = 0L
                        });
            ...
            modelBuilder.Entity("ProjectMonitor.Api.Database.Models.CatBot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Mode = "debug",
                            DiscordConnectionStatus = true,
                            LastDiscordPost = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(478),
                            LastTweet = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(479)
                        },
                        new
                        {
                            Mode = "release",
                            DiscordConnectionStatus = true,
                            LastDiscordPost = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(480),
                            LastTweet = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(481)
                        });
                });
            ...
            modelBuilder.Entity("ProjectMonitor.Api.Database.Models.FinanceManager", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Mode = "debug",
                            LastAPIRefresh = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(466),
                            LastTransactionUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(466)
                        },
                        new
                        {
                            Mode = "release",
                            LastAPIRefresh = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(467),
                            LastTransactionUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(467)
                        });
                });
            ...
            modelBuilder.Entity("ProjectMonitor.Api.Database.Models.RetroAchievementsTracker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Mode = "debug",
                            GamesUpdated = 0L,
                            LastGameUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(446),
                            TotalGames = 0L,
                            TotalUsers = 0L
                        },
                        new
                        {
                            Mode = "release",
                            GamesUpdated = 0L,
                            LastGameUpdate = new DateTime(2022, 10, 4, 20, 49, 49, 509, DateTimeKind.Utc).AddTicks(447),
                            TotalGames = 0L,
                            TotalUsers = 0L
                        });
                });
