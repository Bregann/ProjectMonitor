...
namespace ProjectMonitor.Api.Migrations
{
    ...
    [Migration("20221004204012_FinanceAndCatbotTables")]
    partial class FinanceAndCatbotTables
    {
            ...
            modelBuilder.Entity("ProjectMonitor.Api.Database.Models.BreganTwitchBot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastDiscordLeaderboardsUpdate = new DateTime(2022, 10, 4, 20, 40, 12, 623, DateTimeKind.Utc).AddTicks(1788),
                            LastHoursUpdate = new DateTime(2022, 10, 4, 20, 40, 12, 623, DateTimeKind.Utc).AddTicks(1788),
                            StreamAnnounced = false,
                            StreamStatus = false,
                            StreamUptime = new TimeSpan(0, 0, 0, 1, 0),
                            TwitchApiKeyLastRefreshTime = new DateTime(2022, 10, 4, 20, 40, 12, 623, DateTimeKind.Utc).AddTicks(1791),
                        ...
                        new
                        {
                            ...
                            DailyPointsEnabled = false,
                            DiscordConnectionStatus = true,
                            LastDiscordLeaderboardsUpdate = new DateTime(2022, 10, 4, 20, 40, 12, 623, DateTimeKind.Utc).AddTicks(1793),
                            LastHoursUpdate = new DateTime(2022, 10, 4, 20, 40, 12, 623, DateTimeKind.Utc).AddTicks(1793),
                            StreamAnnounced = false,
                            StreamStatus = false,
                            StreamUptime = new TimeSpan(0, 0, 0, 1, 0),
                            TwitchApiKeyLastRefreshTime = new DateTime(2022, 10, 4, 20, 40, 12, 623, DateTimeKind.Utc).AddTicks(1794),
                            TwitchIRCConnectionStatus = true,
                            TwitchPubSubConnectionStatus = true,
                            UsersInStream = 0L
                        });
