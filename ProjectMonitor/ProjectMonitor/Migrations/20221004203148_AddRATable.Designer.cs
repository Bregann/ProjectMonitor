...
namespace ProjectMonitor.Api.Migrations
{
    ...
    [Migration("20221004203148_AddRATable")]
    partial class AddRATable
    {
            ...
            modelBuilder.Entity("ProjectMonitor.Api.Database.Models.BreganTwitchBot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastDiscordLeaderboardsUpdate = new DateTime(2022, 10, 4, 20, 31, 48, 788, DateTimeKind.Utc).AddTicks(5172),
                            LastHoursUpdate = new DateTime(2022, 10, 4, 20, 31, 48, 788, DateTimeKind.Utc).AddTicks(5172),
                            StreamAnnounced = false,
                            StreamStatus = false,
                            StreamUptime = new TimeSpan(0, 0, 0, 1, 0),
                            TwitchApiKeyLastRefreshTime = new DateTime(2022, 10, 4, 20, 31, 48, 788, DateTimeKind.Utc).AddTicks(5175),
                        ...
                        new
                        {
                            ...
                            DailyPointsEnabled = false,
                            DiscordConnectionStatus = true,
                            LastDiscordLeaderboardsUpdate = new DateTime(2022, 10, 4, 20, 31, 48, 788, DateTimeKind.Utc).AddTicks(5177),
                            LastHoursUpdate = new DateTime(2022, 10, 4, 20, 31, 48, 788, DateTimeKind.Utc).AddTicks(5177),
                            StreamAnnounced = false,
                            StreamStatus = false,
                            StreamUptime = new TimeSpan(0, 0, 0, 1, 0),
                            TwitchApiKeyLastRefreshTime = new DateTime(2022, 10, 4, 20, 31, 48, 788, DateTimeKind.Utc).AddTicks(5178),
                            TwitchIRCConnectionStatus = true,
                            TwitchPubSubConnectionStatus = true,
                            UsersInStream = 0L
                        });
